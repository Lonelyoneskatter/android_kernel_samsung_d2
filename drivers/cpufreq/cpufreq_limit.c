...
static uint32_t post_throttle_freq = 1512000;
static uint32_t pre_throttle_freq = 1512000;
static uint32_t scaling_max_freq = 1512000;
static uint32_t scaling_min_freq = 384000;
