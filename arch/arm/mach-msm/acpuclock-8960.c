...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
	{ 1, {    54000, HFPLL, 2, 0x04 }, L2(0),   850000, AVS(0x40001F) },
	{ 1, {   108000, HFPLL, 2, 0x08 }, L2(0),   850000, AVS(0x40001F) },
	{ 1, {   162000, HFPLL, 2, 0x0C }, L2(0),   850000, AVS(0x40001F) },
	{ 1, {   216000, HFPLL, 2, 0x10 }, L2(0),   875000, AVS(0x40001F) },
	{ 1, {   270000, HFPLL, 2, 0x14 }, L2(0),   875000, AVS(0x40001F) },
	{ 1, {   324000, HFPLL, 2, 0x18 }, L2(0),   900000, AVS(0x40001F) },
	...
	{ 1, {  1404000, HFPLL, 1, 0x34 }, L2(18), 1175000, AVS(0x400015) },
...
static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
	{ 1, {    54000, HFPLL, 2, 0x04 }, L2(0),   800000, AVS(0x40007F) },
	{ 1, {   108000, HFPLL, 2, 0x08 }, L2(0),   800000, AVS(0x40007F) },
	{ 1, {   162000, HFPLL, 2, 0x0C }, L2(0),   800000, AVS(0x40007F) },
	{ 1, {   216000, HFPLL, 2, 0x10 }, L2(0),   825000, AVS(0x40007F) },
	{ 1, {   270000, HFPLL, 2, 0x14 }, L2(0),   825000, AVS(0x40007F) },
	{ 1, {   324000, HFPLL, 2, 0x18 }, L2(0),   850000, AVS(0x40007F) },
	...
	{ 1, {  1782000, HFPLL, 1, 0x42 }, L2(18), 1250000 },
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(18), 1275000 },
	{ 1, {  1890000, HFPLL, 1, 0x45 }, L2(18), 1300000 },
	{ 1, {  1944000, HFPLL, 1, 0x46 }, L2(18), 1325000 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_fast[] __initdata = {
	{ 1, {    54000, HFPLL, 2, 0x04 }, L2(0),   750000, AVS(0x4000FF) },
	{ 1, {   108000, HFPLL, 2, 0x08 }, L2(0),   750000, AVS(0x4000FF) },
	{ 1, {   162000, HFPLL, 2, 0x0C }, L2(0),   750000, AVS(0x4000FF) },
	{ 1, {   216000, HFPLL, 2, 0x10 }, L2(0),   775000, AVS(0x4000FF) },
	{ 1, {   270000, HFPLL, 2, 0x14 }, L2(0),   775000, AVS(0x4000FF) },
	{ 1, {   324000, HFPLL, 2, 0x18 }, L2(0),   800000, AVS(0x4000FF) },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   800000, AVS(0x4000FF) },
	{ 1, {   432000, HFPLL, 2, 0x20 }, L2(6),   825000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(6),   825000 },
	{ 1, {   540000, HFPLL, 2, 0x28 }, L2(6),   850000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(6),   850000 },
	{ 1, {   648000, HFPLL, 1, 0x18 }, L2(6),   875000 },
	...
	{ 1, {  1080000, HFPLL, 1, 0x28 }, L2(18), 1025000, AVS(0x10001B) },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(18), 1025000, AVS(0x10001B) },
	{ 1, {  1188000, HFPLL, 1, 0x2C }, L2(18), 1050000, AVS(0x10001B) },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(18), 1050000, AVS(0x10001B) },
	{ 1, {  1296000, HFPLL, 1, 0x30 }, L2(18), 1075000, AVS(0x10001B) },
